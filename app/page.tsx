            ...
            <div className="text-gray-700 animate-fadeIn mt-6" style={{ marginBottom: '0.75rem' }}>
              ...
              <div style={{ marginTop: '1.5rem' }}>
                ...
                <div className="flex flex-wrap gap-x-3 gap-y-1">
                  {["Python", "Java", "C", "JavaScript", "HTML", "CSS", "React", "Next.js", "Vue", "Nuxt", "React Native", "Tailwind", "Firebase", "Supabase", "PostgreSQL", "MongoDB", "Manim", "Google Cloud", "Vercel", "Git/GitHub"].map((skill) => (
                    <span
                      key={skill}
